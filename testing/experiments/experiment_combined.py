...
fetch_algorithm(exp, "experiment-downward-siwr", "downward_siwr_0", "siwr_0")
fetch_algorithm(exp, "experiment-downward-siwr", "downward_siwr_1", "siwr_1")
fetch_algorithm(exp, "experiment-downward-siwr", "downward_siwr_2", "siwr_2")

report = os.path.join(exp.eval_dir, f"{exp.name}.html")
exp.add_report(BaseReport(attributes=ATTRIBUTES, filter_algorithm=["lama_first", "dual_bfws", "siwr_0", "siwr_1", "siwr_2", "h_policy_0", "h_policy_1", "h_policy_2"]), outfile=report)
exp.run_steps()
